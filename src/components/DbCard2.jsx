  ...
  return (
    <div>
      <section className="container px-4 mx-auto">
        <div className="p-5 flex items-center gap-x-6"></div>
              ...
              <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    ...
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      ...
                      <td className="px-4 py-4 text font-medium text-gray-700 whitespace-nowrap">
                        ...
                        <h6 className="text-sm font-normal">
                          Bring all your news into one place
                        </h6>
                      </td>
                ...
                <div className="flex">
                  ...
                  <div className="page-row items-center hidden lg:flex">
                    <a
                      href="#"
                      className="ml-80 pl-rem-80 py-1 text-sm text-gray-500 rounded-md dark:hover:bg-gray-800 dark:text-gray-300 hover:bg-gray-100"
                    >
                      Page 1 of 10
                    </a>
                  </div>
